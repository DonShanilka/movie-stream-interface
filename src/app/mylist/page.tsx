...
export default function MyListPage() {
    ...
    // Filtered Content
    const favoriteMovies = movies.filter(m => favorites.some(f => f.type === 'movie' && (f.id === m.Id || f.id === m.Title)));
    const favoriteSeries = seriesList.filter(s => favorites.some(f => f.type === 'series' && f.id === s.ID));
